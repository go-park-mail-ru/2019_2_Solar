...
func PinBoardServiceCreate(serviceName string) (Client pinboard_service.PinBoardServiceClient) {
	var err error
...
func AuthServiceCreate(serviceName string) (Client services.AuthorizationServiceClient) {
	var err error
	config := consulapi.DefaultConfig()
	config.Address = consulAddr
	consul, err = consulapi.NewClient(config)
	...
	client := services.NewAuthorizationServiceClient(grpcConn)
...
func UserServiceCreate(serviceName string) (Client user_service.UserServiceClient) {
	var err error
	config := consulapi.DefaultConfig()
	config.Address = consulAddr
	consul, err = consulapi.NewClient(config)
